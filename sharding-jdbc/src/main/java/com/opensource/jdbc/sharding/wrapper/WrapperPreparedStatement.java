...
import com.opensource.jdbc.sharding.PreparedStatementHolder;
...
public class WrapperPreparedStatement extends WrapperStatement implements PreparedStatement {
	...
	public boolean execute() throws SQLException {
		...
		List<PreparedStatementHolder> preparedStatementList=dispatcher.createPreparedStatement(this,sql, parameters); 
		boolean flag=false;
		for(PreparedStatementHolder holder:preparedStatementList){
	...
	public ResultSet executeQuery() throws SQLException {
		...
		for(PreparedStatementHolder holder:preparedStatementList){
			currentPreparedStatement=holder.getPreparedStatement();
			preparedStatements.add(holder.getPreparedStatement());
			ResultSet resultSet=holder.getPreparedStatement().executeQuery(holder.getSql());
